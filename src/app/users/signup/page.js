							...
							<div className="card-body">
								<form onSubmit={handleSubmit}>
									...
									<div className="input-group mb-3">
										...
										<input type="text" className="form-control" placeholder="First Name" value={fullName} onChange={handlefullName} required />
									</div>
									<div className="input-group mb-3">
										<span className="input-group-addon"><i className="fa fa-whatsapp"></i></span>
									...
									<div className="input-group mb-3">
										<span className="input-group-addon"><i className="fa fa-lock"></i></span>
										<input type="password" className="form-control" placeholder="pronouns" value={pronouns} onChange={handlePronouns} required />
									</div>
									<div className="row">
										<div className="col-6">
